...
python ./codes/data_scripts/extract_subimages_train.py
"""
import os
...
def main():
    ...
    if mode == 'pair':
        # cut training data
        GT_folder = './datasets/train_label_img'# fix to your path
        LR_folder = './datasets/train_input_img'# fix to your path
        save_GT_folder = './datasets/train_GT_sub_img'
        save_LR_folder = './datasets/train_LR_sub_img'
